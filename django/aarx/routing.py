...
from prescription.consumers import ChatConsumer, FulfillmentConsumer, StoreFulfillmentConsumer, DeliveryPartnerConsumer
...
websocket_urlpatterns = [
    ...
    path('ws/delivery-partner/', DeliveryPartnerConsumer.as_asgi()),
