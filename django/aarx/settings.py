...
API_RATE_LIMIT_RULES = [
    ...
    {'pattern': r'^/api/store/google-login/?$', 'methods': {'POST'}, 'scope': 'login'},
    {'pattern': r'^/api/store/google/link/?$', 'methods': {'POST'}, 'scope': 'login'},
    {'pattern': r'^/api/store/otp-login/?$', 'methods': {'POST'}, 'scope': 'otp_verify'},
...
MIDDLEWARE = [
    ...
    'support_admin.middleware.ProductionRequestLoggingMiddleware',
