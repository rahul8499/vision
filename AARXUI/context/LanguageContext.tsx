...
const resources = {
  en: {
    auto: autoTranslations.en, translation: {
      nav: { home: 'Home', upload: 'Upload', offers: 'Offer', enquiry: 'Enquiry', orders: 'Order', chat: 'Chat', support: 'Support', reports: 'Reports', history: 'History', settings: 'Settings', profile: 'Profile', documents: 'Documents', replacements: 'Replacements' },
      'nav.home': 'Home', 'nav.upload': 'Upload', 'nav.offers': 'Offer', 'nav.enquiry': 'Enquiry', 'nav.orders': 'Order', 'nav.chat': 'Chat', 'nav.support': 'Support', 'nav.reports': 'Reports', 'nav.history': 'History', 'nav.settings': 'Settings', 'nav.profile': 'Profile', 'nav.documents': 'Documents', 'nav.replacements': 'Replacements',
      Home: 'Home', Upload: 'Upload', Offer: 'Offer', Offers: 'Offer', Enquiry: 'Enquiry', Order: 'Order', Orders: 'Order', Chat: 'Chat', Support: 'Support', Reports: 'Reports', History: 'History', Settings: 'Settings', Profile: 'Profile', Documents: 'Documents', Replacements: 'Replacements',
  ...
  hi: {
    auto: autoTranslations.hi, translation: {
      ...
      'nav.home': 'होम', 'nav.upload': 'अपलोड', 'nav.offers': 'ऑफर', 'nav.enquiry': 'पूछताछ', 'nav.orders': 'ऑर्डर', 'nav.chat': 'चैट', 'nav.support': 'सहायता', 'nav.reports': 'रिपोर्ट', 'nav.history': 'इतिहास', 'nav.settings': 'सेटिंग्स', 'nav.profile': 'प्रोफाइल', 'nav.documents': 'दस्तावेज़', 'nav.replacements': 'रिप्लेसमेंट',
      Home: 'होम', Upload: 'अपलोड', Offer: 'ऑफर', Offers: 'ऑफर', Enquiry: 'पूछताछ', Order: 'ऑर्डर', Orders: 'ऑर्डर', Chat: 'चैट', Support: 'सहायता', Reports: 'रिपोर्ट', History: 'इतिहास', Settings: 'सेटिंग्स', Profile: 'प्रोफाइल', Documents: 'दस्तावेज़', Replacements: 'रिप्लेसमेंट',
  ...
  mr: {
    auto: autoTranslations.mr, translation: {
      ...
      'nav.home': 'होम', 'nav.upload': 'अपलोड', 'nav.offers': 'ऑफर', 'nav.enquiry': 'चौकशी', 'nav.orders': 'ऑर्डर', 'nav.chat': 'चॅट', 'nav.support': 'मदत', 'nav.reports': 'अहवाल', 'nav.history': 'इतिहास', 'nav.settings': 'सेटिंग्ज', 'nav.profile': 'प्रोफाइल', 'nav.documents': 'कागदपत्रे', 'nav.replacements': 'बदली',
      Home: 'होम', Upload: 'अपलोड', Offer: 'ऑफर', Offers: 'ऑफर', Enquiry: 'चौकशी', Order: 'ऑर्डर', Orders: 'ऑर्डर', Chat: 'चॅट', Support: 'मदत', Reports: 'अहवाल', History: 'इतिहास', Settings: 'सेटिंग्ज', Profile: 'प्रोफाइल', Documents: 'कागदपत्रे', Replacements: 'बदली',
