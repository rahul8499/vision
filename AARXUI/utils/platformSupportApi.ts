...
export type SupportTicket={id:number;category:string;category_display:string;subject:string;description:string;priority:string;priority_display:string;status:string;status_display:string;assigned_to:string|null;resolution_note:string|null;resolved_at:string|null;created_at:string;updated_at:string;message_count:number;unread_count:number;messages?:SupportMessage[]};
