...
export default function ActiveOrdersScreen() {
  ...
  const confirmPickupFallback = useCallback(() => {
    ...
    Alert.alert(
      ...
      'Delivery partner unavailable hai. Customer se confirm karke hi order ko pickup flow me move karein.',
      [
        { text: 'नहीं', style: 'cancel' },
        { text: 'Yes, Customer Confirmed', onPress: async () => {
